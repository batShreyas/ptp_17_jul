 ...
 * @param opts A pointer to the ptpd_opts runtime options.
 */
void do_state_initializing(ptp_clock_t *clock, ptpd_opts *opts)
{
 ...
 * @param opts A pointer to the ptpd_opts runtime options.
 */
void do_state_listening(ptp_clock_t *clock, ptpd_opts *opts)
{
 ...
 * @param opts A pointer to the ptpd_opts runtime options.
 */
void do_state_master(ptp_clock_t *clock, ptpd_opts *opts)
{
 ...
 * @param opts A pointer to the ptpd_opts runtime options.
 */
void do_state_slave(ptp_clock_t *clock, ptpd_opts *opts)
{
 ...
 * @param opts A pointer to the ptpd_opts runtime options.
 */
void do_state_other(ptp_clock_t *clock, ptpd_opts *opts)
{
 ...
 * @param opts A pointer to the ptpd_opts runtime options.
 */
void do_state(ptp_clock_t *clock, ptpd_opts *opts)
{
 ...
 * @param opts A pointer to the ptpd_opts runtime options.
 */
void to_state(ptp_port_state_t state, ptp_clock_t *clock, ptpd_opts *opts)
{
